...
export default function Navbar() {
  ...
  return (
    <nav className="w-full bg-[#1A1A1A] px-6 py-4 flex items-center justify-between border-b border-white/10">
      <div className="flex items-center gap-8">
        ...
        <div className="flex items-center gap-4">
          <Link
            href="/home"
            className="flex items-center gap-2 text-[#CDFF63] px-3 py-1.5 rounded-lg bg-white/5 text-sm"
          >
            <svg
              className="w-4 h-4"
              fill="none"
